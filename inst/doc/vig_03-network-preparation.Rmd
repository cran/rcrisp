...
plot(network_new_nodes, col = "darkgreen",
     xlim = c(425100, 425400), ylim = c(4922400, 4923000),
     main = "After preprocessing", add = TRUE)
...
<div class="figure">
<img src="img/vig_03-network-preparation-plot-network-1.png" alt="Comparison of the spatial network before and after preprocessing." width="100%" />
<p class="caption">The network before and after preprocessing.</p>
</div>
